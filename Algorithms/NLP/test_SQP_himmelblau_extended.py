...
# Line search BFGS
results = solveSQP_Line(x,z,y,s,f,g,h,df,dg,dh,MaxIter = 100, tol=10**(-4), LDL = True)

# Line search Hessian
#results = solveSQP_Line(x,z,y,s,f,g,h,df,dg,dh,d2f,d2g,d2h,MaxIter = 100, tol=10**(-4), LDL = True)

# Trust region BFGS
#results = solveSQP_Trust(x,z,y,s,f,g,h_ext,df,dg,dh_ext, MaxIter = 100, tol=10**(-4), QPMaxIter = 100, QPtol = 10**(-6), LDL = False)
